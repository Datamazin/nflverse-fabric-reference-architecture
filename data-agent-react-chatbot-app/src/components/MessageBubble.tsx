...
export function MessageBubble({ message, onFeedback }: MessageBubbleProps) {
  ...
  return (
    <div className="mb-6">
      ...
      {/* Timing + Feedback + Debug controls */}
      ...
      {showDebug && message.debugRequest && message.debugResponse && (
        <DebugModal
          request={message.debugRequest}
          response={message.debugResponse}
